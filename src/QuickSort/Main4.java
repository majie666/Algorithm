...
import MergeSort.SortTestHelper;
...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        for( int i = 0 ; i < T ; i ++ ) {
            ...
            time1 += SortTestHelper.testSort2("ShellSort.ShellSort", arr1);
            time2 += SortTestHelper.testSort2("MergeSort.MergeSort", arr2);
            time3 += SortTestHelper.testSort2("QuickSort.QuickSort", arr3);
            time4 += SortTestHelper.testSort2("QuickSort.QuickSort2Ways", arr4);
            time5 += SortTestHelper.testSort2("QuickSort.QuickSort3Ways", arr5);
        }
