...
import WeightedGraph.ReadWeightedGraph;
import WeightedGraph.SparseWeightedGraph;

public class BellmanFord_Main {
    // 测试我们的Bellman-Ford最短路径算法
    public static void main(String[] args) {

        String filename = "testG2_ShortestPath.txt";
//        String filename = "testG_negative_circle_ShortestPath.txt";
        int V = 5;
